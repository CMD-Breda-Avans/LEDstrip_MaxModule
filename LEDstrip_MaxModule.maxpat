...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 808.0, 211.0, 231.0, 20.0 ],
					"presentation_linecount" : 2,
					"text" : "SLIDER Brightness - check info for range"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 790.0, 14.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 790.0, 49.0, 29.5, 22.0 ],
					"text" : "100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 790.0, 287.0, 40.0, 22.0 ],
					"text" : "* 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 790.0, 80.0, 50.0, 119.0 ],
					"size" : 101.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 790.0, 329.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 683.0, 363.0, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 581.0, 363.0, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 477.0, 363.0, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 683.0, 396.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 581.0, 396.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 477.0, 396.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 325.0, 20.0, 20.0 ],
					"text" : "W"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 657.0, 325.0, 20.0, 20.0 ],
					"text" : "B"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 553.0, 325.0, 20.0, 20.0 ],
					"text" : "G"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.0, 325.0, 20.0, 20.0 ],
					"text" : "R"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 476.0, 49.0, 150.0, 20.0 ],
					"text" : "SWATCH object"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 683.0, 325.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 581.0, 325.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 477.0, 325.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.0, 287.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.0, 287.0, 97.0, 22.0 ],
					"text" : "scale 0. 1. 0 255"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 477.0, 232.0, 67.0, 22.0 ],
					"text" : "unpack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 287.0, 97.0, 22.0 ],
					"text" : "scale 0. 1. 0 255"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 177.0, 206.0, 22.0 ],
					"text" : "1. 1. 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 476.0, 80.0, 165.0, 77.0 ],
					"saturation" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 363.545454545454561, 325.0, 50.0, 22.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-3",
									"items" : [ "wlan-debug", ",", "Bluetooth-Incoming-Port", ",", "usbmodem101" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 307.0, 449.0, 641.0, 249.0 ],
					"viewvisibility" : 1
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 1 ],
					"midpoints" : [ 485.5, 166.5, 695.5, 166.5 ],
					"order" : 0,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 510.5, 274.0, 590.5, 274.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 534.5, 267.0, 692.5, 267.0 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 799.5, 356.5, 497.0, 356.5 ],
					"order" : 2,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 799.5, 356.5, 601.0, 356.5 ],
					"order" : 1,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 1 ],
					"midpoints" : [ 799.5, 356.5, 703.0, 356.5 ],
					"order" : 0,
					"source" : [ "obj-33", 0 ]
				}
